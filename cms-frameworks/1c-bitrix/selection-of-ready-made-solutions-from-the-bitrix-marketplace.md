...
<a name="evolat"></a>
## [Evolat](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=419367.php)

<a name="ms.ubershop"></a>
...
<a name="intec"></a>
## [«INTEC» интернет-агентство](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=193047.php)

Готовые решения под разные тематики сайтов.

<a name="ranx"></a>
## [RANX](http://marketplace.1c-bitrix.ru/partners/detail.php?ID=8910405.php)

<a name="ranx.landing"></a>
...
<a name="af"></a>
## [Александр Ирбис](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=1226703.php)

<a name="af.whiteplus"></a>
...
<a name="redsign"></a>
## [АЛЬФА Системс](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=164683.php)

Готовые решения под разные тематики сайтов. В данном списке выбраны готовые решения на общие тематики под интернет-магазины и корпоративные сайты. Большее количество готовых решений на странице разработчика.

<a name="redsign.megamart"></a>
...
<a name="vebfabrika"></a>
## [Интернет-агентство «Веб Фабрика»](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=1899461.php)

Готовые решения под разные тематики сайтов.

<a name="gvozdevsoft"></a>
## [ГВОЗДЕВСОФТ](https://marketplace.1c-bitrix.ru/partners/detail.php?ID=2929645.php)
